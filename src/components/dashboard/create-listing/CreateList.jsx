...
const CreateList = () => {
  ...
  const handleFormField = (ev) => {
    ...
    // this condition work for html select element
    ...
    // this condition work for html input  element of type text
    if (target_node.nodeName === "INPUT" || target_node.nodeName === "input") {
      const db_field_name = target_node.name;
      // this condition work for input type file
      if (target_node === "file" || target_node === "FILE") {

      }
      // this condition work for input type checkbox
      if (target_node === "checkbox" || target_node === "CHECKBOX") {
        const db_field_value = target_node.value;
      }
      console.log(db_field_name, "=>", target_node.type);
    }
